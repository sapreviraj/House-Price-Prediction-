...
numvar<-c('LotArea','TotalBsmtSF','GrLivArea','BedroomAbvGr','GarageCars','GarageArea','OpenPorchSF','EnclosedPorch','WoodDeckSF','PoolArea','Age')
...
my_data <- training[, c('SalePrice','LotArea','TotalBsmtSF','GrLivArea','GarageArea','Age')]

chart.Correlation(my_data, histogram=TRUE, pch=19)
```

```{r}
my_data <- training[, c('SalePrice','OpenPorchSF','EnclosedPorch','WoodDeckSF')]
...
```
```{r}
num_var <- c('SalePrice','LotArea','TotalBsmtSF','GrLivArea','GarageArea','Age','WoodDeckSF','OpenPorchSF','PoolArea')
